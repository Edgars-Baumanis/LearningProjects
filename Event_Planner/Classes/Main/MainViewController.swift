...
class MainViewController: UIViewController {
    ...
    private func makeInfoButton() {
        ...
        NSLayoutConstraint.activate([barInfoButton.customView!.widthAnchor.constraint(equalToConstant: 30), barInfoButton.customView!.heightAnchor.constraint(equalToConstant: 30)])
